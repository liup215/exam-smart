define(['dart_sdk', 'packages/fixnum/fixnum'], (function load__packages__protobuf__protobuf(dart_sdk, packages__fixnum__fixnum) {
  ...
  var LinkedMapOfintL$FieldInfoL = () => (LinkedMapOfintL$FieldInfoL = dart.constFn(_js_helper.LinkedMap$(intL(), FieldInfoL())))();
  ...
  var LinkedMapOfintL$ExtensionL = () => (LinkedMapOfintL$ExtensionL = dart.constFn(_js_helper.LinkedMap$(intL(), ExtensionL())))();
  ...
  var LinkedMapOfintL$UnknownFieldSetFieldL = () => (LinkedMapOfintL$UnknownFieldSetFieldL = dart.constFn(_js_helper.LinkedMap$(intL(), UnknownFieldSetFieldL())))();
  ...
  var intLAndObjectLToNull = () => (intLAndObjectLToNull = dart.constFn(dart.fnType(core.Null, [intL(), ObjectL()])))();
  ...
  var intLAndExtensionLToNull = () => (intLAndExtensionLToNull = dart.constFn(dart.fnType(core.Null, [intL(), ExtensionL()])))();
  ...
  dart.defineLazy(CT, {
    ...
    get C10() {
      return C10 = dart.fn(protobuf.GeneratedMessage._emptyReviver, dynamicAnddynamicTodynamic());
    },
    get C11() {
      return C11 = dart.fn(protobuf._checkFloat, ObjectLTovoid());
    },
    get C12() {
      return C12 = dart.fn(protobuf._checkSigned32, ObjectLTovoid());
    },
    get C13() {
      return C13 = dart.fn(protobuf._checkUnsigned32, ObjectLTovoid());
    },
    get C14() {
    ...
    get C15() {
      return C15 = dart.fn(protobuf.defaultFrozenMessageModificationHandler, StringLAndStringLTovoid());
    }
  }, false);
  ...
  var _writeRawBytes = dart.privateName(protobuf, "_writeRawBytes");
  ...
  protobuf.CodedBufferWriter = class CodedBufferWriter extends core.Object {
    ...
    [_writeValueAs](valueType, value) {
      switch (valueType) {
        ...
        case 2048:
        {
          this[_writeVarint32](intL().as(dart.dsend(value, '&', [4294967295])));
          break;
        }
        case 4096:
        {
    ...
    [_writeBytesNoTag](value) {
      ...
      this[_writeRawBytes](TypedDataL().as(value));
    }
  ...
  dart.setMethodSignature(protobuf.CodedBufferWriter, () => ({
    ...
    [_writeRawBytes]: dart.fnType(dart.void, [dart.legacy(typed_data.TypedData)]),
    ...
    [_writeTag]: dart.fnType(dart.dynamic, [dart.legacy(core.int), dart.legacy(core.int)]),
  ...
  protobuf.BuilderInfo = class BuilderInfo extends core.Object {
    ...
    add(T, tagNumber, name, fieldType, defaultOrMaker, subBuilder, valueOf, enumValues) {
      ...
      this[_addField](new (protobuf.FieldInfo$(dart.legacy(T))).new(name, tagNumber, index, fieldType, defaultOrMaker, subBuilder, valueOf, enumValues));
    }
    addMapField(K, V, tagNumber, name, keyFieldType, valueFieldType, mapEntryBuilderInfo) {
      let index = this.byIndex[$length];
      this[_addField](new (protobuf.MapFieldInfo$(dart.legacy(K), dart.legacy(V))).map(name, tagNumber, index, 6291456, keyFieldType, valueFieldType, mapEntryBuilderInfo));
    }
    addRepeated(T, tagNumber, name, fieldType, check, subBuilder, valueOf, enumValues) {
      let index = this.byIndex[$length];
      this[_addField](new (protobuf.FieldInfo$(dart.legacy(T))).repeated(name, tagNumber, index, fieldType, check, subBuilder, valueOf, enumValues));
    }
    [_addField](fi) {
      this.byIndex[$add](fi);
      if (!dart.equals(this.byIndex[$_get](fi.index), fi)) dart.assertFailed(null, L2, 59, 12, "byIndex[fi.index] == fi");
      if (fi.tagNumber !== 0) {
    ...
    a(T, tagNumber, name, fieldType, defaultOrMaker = null, subBuilder = null, valueOf = null, enumValues = null) {
      this.add(dart.legacy(T), tagNumber, name, fieldType, defaultOrMaker, subBuilder, valueOf, enumValues);
    }
    aOS(tagNumber, name) {
      this.add(StringL(), tagNumber, name, 64, null, null, null, null);
    }
    pPS(tagNumber, name) {
      this.addRepeated(StringL(), tagNumber, name, 66, protobuf.getCheckFunction(66), null, null, null);
    }
    aQS(tagNumber, name) {
      this.add(StringL(), tagNumber, name, 65, null, null, null, null);
    }
    aInt64(tagNumber, name) {
      this.add(Int64L(), tagNumber, name, 4096, fixnum.Int64.ZERO, null, null, null);
    }
    aOB(tagNumber, name) {
      this.add(boolL(), tagNumber, name, 16, null, null, null, null);
    }
    e(T, tagNumber, name, fieldType, defaultOrMaker, valueOf, enumValues) {
      this.add(dart.legacy(T), tagNumber, name, fieldType, defaultOrMaker, null, valueOf, enumValues);
    }
    p(T, tagNumber, name, fieldType) {
      if (!(!dart.test(protobuf._isGroupOrMessage(fieldType)) && !dart.test(protobuf._isEnum(fieldType)))) dart.assertFailed(null, L2, 115, 12, "!_isGroupOrMessage(fieldType) && !_isEnum(fieldType)");
      this.addRepeated(dart.legacy(T), tagNumber, name, fieldType, protobuf.getCheckFunction(fieldType), null, null, null);
    }
    pc(T, tagNumber, name, fieldType, subBuilder = null, valueOf = null, enumValues = null) {
      if (!(dart.test(protobuf._isGroupOrMessage(fieldType)) || dart.test(protobuf._isEnum(fieldType)))) dart.assertFailed(null, L2, 125, 12, "_isGroupOrMessage(fieldType) || _isEnum(fieldType)");
      this.addRepeated(dart.legacy(T), tagNumber, name, fieldType, C1 || CT.C1, subBuilder, valueOf, enumValues);
    }
    pp(T, tagNumber, name, fieldType, check, subBuilder = null, valueOf = null, enumValues = null) {
      if (!(dart.test(protobuf._isGroupOrMessage(fieldType)) || dart.test(protobuf._isEnum(fieldType)))) dart.assertFailed(null, L2, 136, 12, "_isGroupOrMessage(fieldType) || _isEnum(fieldType)");
      this.addRepeated(dart.legacy(T), tagNumber, name, fieldType, C1 || CT.C1, subBuilder, valueOf, enumValues);
    }
    oo(oneofIndex, tags) {
    ...
    m(K, V, tagNumber, name, entryClassName, keyFieldType, valueFieldType, valueCreator = null, valueOf = null, enumValues = null, packageName = C0 || CT.C0) {
      let t0;
      ...
      this.addMapField(dart.legacy(K), dart.legacy(V), tagNumber, name, keyFieldType, valueFieldType, mapEntryBuilderInfo);
    }
  ...
  (protobuf.BuilderInfo.new = function(messageName, opts) {
    ...
    this[fieldInfo] = new (LinkedMapOfintL$FieldInfoL()).new();
  ...
  dart.setMethodSignature(protobuf.BuilderInfo, () => ({
    ...
    aOS: dart.fnType(dart.void, [dart.legacy(core.int), dart.legacy(core.String)]),
    pPS: dart.fnType(dart.void, [dart.legacy(core.int), dart.legacy(core.String)]),
    aQS: dart.fnType(dart.void, [dart.legacy(core.int), dart.legacy(core.String)]),
    aInt64: dart.fnType(dart.void, [dart.legacy(core.int), dart.legacy(core.String)]),
    aOB: dart.fnType(dart.void, [dart.legacy(core.int), dart.legacy(core.String)]),
    e: dart.gFnType(T => [dart.void, [dart.legacy(core.int), dart.legacy(core.String), dart.legacy(core.int), dart.dynamic, dart.legacy(dart.fnType(dart.legacy(protobuf.ProtobufEnum), [dart.legacy(core.int)])), dart.legacy(core.List$(dart.legacy(protobuf.ProtobufEnum)))]]),
    p: dart.gFnType(T => [dart.void, [dart.legacy(core.int), dart.legacy(core.String), dart.legacy(core.int)]]),
    pc: dart.gFnType(T => [dart.void, [dart.legacy(core.int), dart.legacy(core.String), dart.legacy(core.int)], [dart.legacy(dart.fnType(dart.legacy(protobuf.GeneratedMessage), [])), dart.legacy(dart.fnType(dart.legacy(protobuf.ProtobufEnum), [dart.legacy(core.int)])), dart.legacy(core.List$(dart.legacy(protobuf.ProtobufEnum)))]]),
    pp: dart.gFnType(T => [dart.void, [dart.legacy(core.int), dart.legacy(core.String), dart.legacy(core.int), dart.legacy(dart.fnType(dart.void, [dart.legacy(T)]))], [dart.legacy(dart.fnType(dart.legacy(protobuf.GeneratedMessage), [])), dart.legacy(dart.fnType(dart.legacy(protobuf.ProtobufEnum), [dart.legacy(core.int)])), dart.legacy(core.List$(dart.legacy(protobuf.ProtobufEnum)))]]),
    oo: dart.fnType(dart.void, [dart.legacy(core.int), dart.legacy(core.List$(dart.legacy(core.int)))]),
    m: dart.gFnType((K, V) => [dart.void, [dart.legacy(core.int), dart.legacy(core.String), dart.legacy(core.String), dart.legacy(core.int), dart.legacy(core.int)], [dart.legacy(dart.fnType(dart.legacy(protobuf.GeneratedMessage), [])), dart.legacy(dart.fnType(dart.legacy(protobuf.ProtobufEnum), [dart.legacy(core.int)])), dart.legacy(core.List$(dart.legacy(protobuf.ProtobufEnum))), dart.legacy(protobuf.PackageName)]]),
    ...
    [_decodeEnum]: dart.fnType(dart.dynamic, [dart.legacy(core.int), dart.legacy(protobuf.ExtensionRegistry), dart.legacy(core.int)])
  }));
  ...
  var _mapEntryBuilderInfo$ = dart.privateName(protobuf, "_mapEntryBuilderInfo");
  ...
  var tagNumber$ = dart.privateName(protobuf, "FieldInfo.tagNumber");
  ...
  protobuf.FieldInfo$ = dart.generic(T => {
    ...
    class FieldInfo extends core.Object {
      ...
      [_createRepeatedField](m) {
        if (!dart.test(this.isRepeated)) dart.assertFailed(null, L3, 156, 12, "isRepeated");
        return m.createRepeatedField(TL(), this.tagNumber, this);
      }
      [_createRepeatedFieldWithType](S, m) {
        dart.checkTypeBound(S, TL(), 'S');
        if (!dart.test(this.isRepeated)) dart.assertFailed(null, L3, 162, 12, "isRepeated");
    ...
    (FieldInfo.new = function(name, tagNumber, index, type, defaultOrMaker = null, subBuilder = null, valueOf = null, enumValues = null) {
      ...
      if (!(type !== 0)) dart.assertFailed(null, L3, 47, 12, "type != 0");
      if (!(!dart.test(protobuf._isGroupOrMessage(type)) || this.subBuilder != null)) dart.assertFailed(null, L3, 48, 12, "!_isGroupOrMessage(type) || subBuilder != null");
      if (!(!dart.test(protobuf._isEnum(type)) || this.valueOf != null)) dart.assertFailed(null, L3, 49, 12, "!_isEnum(type) || valueOf != null");
    }).prototype = FieldInfo.prototype;
    (FieldInfo.repeated = function(name, tagNumber, index, type, check, subBuilder, valueOf = null, enumValues = null) {
      this[_emptyList] = null;
      this[name$] = name;
      this[tagNumber$] = tagNumber;
      this[index$] = index;
      ...
      this[_mapEntryBuilderInfo$] = null;
      if (!(this.name != null)) dart.assertFailed(null, L3, 58, 12, "name != null");
      if (!(this.tagNumber != null)) dart.assertFailed(null, L3, 59, 12, "tagNumber != null");
      if (!dart.test(protobuf._isRepeated(type))) dart.assertFailed(null, L3, 60, 12, "_isRepeated(type)");
      if (!(this.check != null)) dart.assertFailed(null, L3, 61, 12, "check != null");
      if (!(!dart.test(protobuf._isEnum(type)) || this.valueOf != null)) dart.assertFailed(null, L3, 62, 12, "!_isEnum(type) || valueOf != null");
    }).prototype = FieldInfo.prototype;
    (FieldInfo._map = function(name, tagNumber, index, type, makeDefault, defaultOrMaker = null, subBuilder = null, valueOf = null, enumValues = null, _mapEntryBuilderInfo = null) {
      this[_emptyList] = null;
      this[name$] = name;
      this[tagNumber$] = tagNumber;
      this[index$] = index;
      ...
      this[valueOf$] = valueOf;
      this[enumValues$] = enumValues;
      this[_mapEntryBuilderInfo$] = _mapEntryBuilderInfo;
      this[type$] = type;
      this[check$] = null;
      if (!(this.name != null)) dart.assertFailed(null, L3, 74, 12, "name != null");
      if (!(this.tagNumber != null)) dart.assertFailed(null, L3, 75, 12, "tagNumber != null");
      if (!dart.test(protobuf._isMapField(type))) dart.assertFailed(null, L3, 76, 12, "_isMapField(type)");
    }).prototype = FieldInfo.prototype;
    ...
    dart.setFieldSignature(FieldInfo, () => ({
      ...
      [_mapEntryBuilderInfo$]: dart.finalFieldType(dart.legacy(protobuf.BuilderInfo)),
  ...
  protobuf.Extension$ = dart.generic(T => {
    ...
    (Extension.new = function(extendee, name, tagNumber, fieldType, defaultOrMaker = null, subBuilder = null, valueOf = null, enumValues = null) {
    ...
    (Extension.repeated = function(extendee, name, tagNumber, fieldType, check, subBuilder = null, valueOf = null, enumValues = null) {
      this[extendee$] = extendee;
  ...
  protobuf._ExtensionFieldSet = class _ExtensionFieldSet extends core.Object {
    ...
    [_ensureRepeatedField](T, fi) {
      if (!!dart.test(this[_isReadOnly])) dart.assertFailed(null, L4, 40, 12, "!_isReadOnly");
      if (!dart.test(fi.isRepeated)) dart.assertFailed(null, L4, 41, 12, "fi.isRepeated");
      if (!(fi.extendee == this[_parent$][_messageName])) dart.assertFailed(null, L4, 42, 12, "fi.extendee == _parent._messageName");
    ...
    [_addInfoUnchecked](fi) {
      if (!(fi.extendee == this[_parent$][_messageName])) dart.assertFailed(null, L4, 123, 12, "fi.extendee == _parent._messageName");
    ...
    [_shallowCopyValues](original) {
      ...
      for (let tagNumber of original[_tagNumbers]) {
        ...
        if (dart.test(extension.isRepeated)) {
          if (!PbListBaseL().is(value)) dart.assertFailed(null, L4, 158, 16, "value is PbListBase");
  ...
  protobuf.ExtensionRegistry = class ExtensionRegistry extends core.Object {
    add(extension) {
      let map = this[_extensions][$putIfAbsent](extension.extendee, dart.fn(() => new (LinkedMapOfintL$ExtensionL()).new(), VoidToMapLOfintL$ExtensionL()));
  ...
  protobuf.MapFieldInfo$ = dart.generic((K, V) => {
    ...
    class MapFieldInfo extends protobuf.FieldInfo$(dart.legacy(protobuf.PbMap$(dart.legacy(K), dart.legacy(V)))) {
      ...
      set keyFieldType(value) {
        this[keyFieldType$0] = value;
      }
      get valueFieldType() {
        return this[valueFieldType$0];
      }
      set valueFieldType(value) {
        this[valueFieldType$0] = value;
      }
      get valueCreator() {
      ...
      [_createMapField](m) {
        if (!dart.test(this.isMapField)) dart.assertFailed(null, L3, 205, 12, "isMapField");
    ...
    (MapFieldInfo.map = function(name, tagNumber, index, type, keyFieldType, valueFieldType, mapEntryBuilderInfo) {
      ...
      MapFieldInfo.__proto__._map.call(this, name, tagNumber, index, type, dart.fn(() => new (PbMapOfKL$VL()).new(keyFieldType, valueFieldType, mapEntryBuilderInfo), VoidToPbMapLOfKL$VL()), null, null, null, null, mapEntryBuilderInfo);
      if (!(name != null)) dart.assertFailed(null, L3, 194, 12, "name != null");
      if (!(tagNumber != null)) dart.assertFailed(null, L3, 195, 12, "tagNumber != null");
      if (!dart.test(protobuf._isMapField(type))) dart.assertFailed(null, L3, 196, 12, "_isMapField(type)");
      if (!(!dart.test(protobuf._isEnum(type)) || this.valueOf != null)) dart.assertFailed(null, L3, 197, 12, "!_isEnum(type) || valueOf != null");
    ...
    dart.setFieldSignature(MapFieldInfo, () => ({
      ...
      keyFieldType: dart.fieldType(dart.legacy(core.int)),
      valueFieldType: dart.fieldType(dart.legacy(core.int)),
      valueCreator: dart.fieldType(dart.legacy(dart.fnType(dart.legacy(protobuf.GeneratedMessage), [])))
    }));
    return MapFieldInfo;
  });
  ...
  var _$getN = dart.privateName(protobuf, "_$getN");
  ...
  protobuf._FieldSet = class _FieldSet extends core.Object {
    ...
    [_getDefaultList](T, fi) {
      if (!dart.test(fi.isRepeated)) dart.assertFailed(null, L5, 196, 12, "fi.isRepeated");
      if (dart.test(this[_isReadOnly])) return core.List$(dart.legacy(T)).unmodifiable(C2 || CT.C2);
    ...
    [_getDefaultMap](K, V, fi) {
      if (!dart.test(fi.isMapField)) dart.assertFailed(null, L5, 208, 12, "fi.isMapField");
      if (dart.test(this[_isReadOnly])) return new (protobuf.PbMap$(dart.legacy(K), dart.legacy(V))).unmodifiable(new (protobuf.PbMap$(dart.legacy(K), dart.legacy(V))).new(fi.keyFieldType, fi.valueFieldType, fi[_mapEntryBuilderInfo$]));
    ...
    [_setFieldUnchecked](fi, value) {
      let t0;
      if (!(fi != null)) dart.assertFailed(null, L5, 299, 12, "fi != null");
      if (!!dart.test(fi.isRepeated)) dart.assertFailed(null, L5, 300, 12, "!fi.isRepeated");
      if (fi.index == null) {
    ...
    [_ensureRepeatedField](T, fi) {
      if (!!dart.test(this[_isReadOnly])) dart.assertFailed(null, L5, 317, 12, "!_isReadOnly");
      if (!dart.test(fi.isRepeated)) dart.assertFailed(null, L5, 318, 12, "fi.isRepeated");
      if (fi.index == null) {
    ...
    [_ensureMapField](K, V, fi) {
      if (!!dart.test(this[_isReadOnly])) dart.assertFailed(null, L5, 331, 12, "!_isReadOnly");
      if (!dart.test(fi.isMapField)) dart.assertFailed(null, L5, 332, 12, "fi.isMapField");
      if (!(fi.index != null)) dart.assertFailed(null, L5, 333, 12, "fi.index != null");
      let value = this[_getFieldOrNull](fi);
    ...
    [_$set](index, value) {
      if (!!dart.test(this[_nonExtensionInfoByIndex](index).isRepeated)) dart.assertFailed(null, L5, 428, 12, "!_nonExtensionInfoByIndex(index).isRepeated");
      if (!dart.test(this[_$check](index, value))) dart.assertFailed(null, L5, 429, 12, "_$check(index, value)");
      this[_ensureWritable]();
      if (value == null) {
    ...
    [_mergeField](otherFi, fieldValue, opts) {
      ...
      if (dart.test(fi.isMapField)) {
        ...
        if (dart.test(mustClone)) {
          for (let t0 of IterableL().as(dart.dload(fieldValue, 'entries'))) {
            ...
            map._set(entry.key, protobuf._FieldSet._cloneMessage(GeneratedMessageL().as(entry.value)));
          }
        } else {
      ...
      if (dart.test(otherFi.isGroupOrMessage)) {
        ...
        if (currentFi == null) {
          fieldValue = protobuf._FieldSet._cloneMessage(GeneratedMessageL().as(fieldValue));
        } else {
  ...
  (protobuf._FieldSet.new = function(_message, meta, _eventPlugin) {
    ...
    this[_meta] = meta;
    this[_values] = ListL().as(protobuf._FieldSet._makeValueList(meta.byIndex[$length]));
  ...
  dart.setMethodSignature(protobuf._FieldSet, () => ({
    ...
    [_$getN]: dart.gFnType(T => [dart.legacy(T), [dart.legacy(core.int)]]),
  ...
  protobuf.GeneratedMessage = class GeneratedMessage extends core.Object {
    ...
    mergeFromJson(data, extensionRegistry = C3 || CT.C3) {
      let jsonMap = MapLOfStringL$dynamic().as(convert.jsonDecode(data, {reviver: C10 || CT.C10}));
    ...
    createMapField(K, V, tagNumber, fi) {
      return new (protobuf.PbMap$(dart.legacy(K), dart.legacy(V))).new(fi.keyFieldType, fi.valueFieldType, fi[_mapEntryBuilderInfo$]);
    }
    ...
    $_getN(T, index) {
      return this[_fieldSet][_$getN](dart.legacy(T), index);
    }
    $_getList(T, index) {
  ...
  protobuf.PbListBase$ = dart.generic(E => {
    ...
    (PbListBase._noList = function(opts) {
      ...
      if (!(this.check != null)) dart.assertFailed(null, L6, 162, 12, "check != null");
    }).prototype = PbListBase.prototype;
  ...
  protobuf.ProtobufEnum = class ProtobufEnum extends core.Object {
    ...
    static initByValue(T, byIndex) {
      let byValue = new (_js_helper.LinkedMap$(intL(), dart.legacy(T))).new();
  ...
  protobuf.UnknownFieldSet = class UnknownFieldSet extends core.Object {
    ...
    [_getField](number) {
      this[_checkFieldNumber](number);
      if (dart.test(this[_isReadOnly])) if (!dart.test(this[_fields][$containsKey](number))) dart.assertFailed(null, L7, 129, 29, "_fields.containsKey(number)");
  ...
  (protobuf.UnknownFieldSet.new = function() {
    this[_fields] = new (LinkedMapOfintL$UnknownFieldSetFieldL()).new();
    this[_isReadOnly] = false;
    ;
  ...
  dart.setMethodSignature(protobuf.UnknownFieldSet, () => ({
    ...
    [_checkFieldNumber]: dart.fnType(dart.dynamic, [dart.legacy(core.int)]),
  ...
  protobuf._reparseMessage = function _reparseMessage(T, message, extensionRegistry) {
    let t1;
    let result = dart.legacy(T).as(message.createEmptyInstance());
    result[_fieldSet][_shallowCopyValues](message[_fieldSet]);
    let resultUnknownFields = result[_fieldSet][_unknownFields];
  ...
  protobuf._appendJsonMap = function _appendJsonMap(fs, jsonList, fi, registry) {
    ...
    for (let t1 of jsonList) {
      let jsonEntry = MapLOfStringL$dynamic().as(t1);
  ...
  protobuf.sorted = function sorted(T, list) {
    let t2;
    t2 = core.List$(dart.legacy(T)).from(list);
    return (() => {
      t2[$sort]();
      return t2;
    })();
  ...
  protobuf.getTagFieldNumber = function getTagFieldNumber(tag) {
    return (dart.notNull(tag) & 2147483647)[$rightShift](3);
  };
