...
import 'package:angular_components/material_select/handles_aria.template.dart' as _ref5;
...
import '../utils/id_generator/id_generator.dart' as import29;
import '../model/selection/selection_container.dart' as import30;
import '../model/ui/has_renderer.dart' as import31;
...
class ViewMaterialSelectDropdownItemComponent0<T> extends import1.ComponentView<import2.MaterialSelectDropdownItemComponent<T>> {
  ...
  ViewMaterialSelectDropdownItemComponent0(import6.View parentView, int parentIndex) : super(parentView, parentIndex, ChangeDetectionStrategy.CheckOnce) {
    ...
    this.rootElement = import8.document.createElement('material-select-dropdown-item');
    this.updateChildClassNonHtml(this.rootElement, import2.MaterialSelectDropdownItemComponent.hostClass);
  }
  static String get _debugComponentUrl {
    return (import9.isDevMode ? 'asset:angular_components/lib/material_select/material_select_dropdown_item.dart' : null);
  }
  ...
  void build() {
    ...
    parentRenderNode.addEventListener('mousedown', this.eventHandler1(_ctx.preventTextSelectionIfShiftKey));
  }
  ...
  void detectHostChanges(bool firstCheck) {
    ...
    if (import9.checkBinding(this._expr_9, currVal_9, null, null)) {
      import10.updateAttribute(this.rootElement, 'id', currVal_9);
      this._expr_9 = currVal_9;
    }
    final currVal_10 = _ctx.isSelected;
    if (import9.checkBinding(this._expr_10, currVal_10, null, null)) {
      import10.updateAttribute(this.rootElement, 'aria-selected', currVal_10?.toString());
...
class _ViewMaterialSelectDropdownItemComponent1<T> extends import13.EmbeddedView<import2.MaterialSelectDropdownItemComponent<T>> {
  _ViewMaterialSelectDropdownItemComponent1(import14.RenderView parentView, int parentIndex) : super(parentView, parentIndex);
  @override
  void build() {
...
import13.EmbeddedView<void> viewFactory_MaterialSelectDropdownItemComponent1<T>(import14.RenderView parentView, int parentIndex) {
  return _ViewMaterialSelectDropdownItemComponent1<T>(parentView, parentIndex);
}

class _ViewMaterialSelectDropdownItemComponent2<T> extends import13.EmbeddedView<import2.MaterialSelectDropdownItemComponent<T>> {
  ViewContainer _appEl_0;
  NgIf _NgIf_0_9;
  ViewContainer _appEl_2;
  NgIf _NgIf_2_9;
  _ViewMaterialSelectDropdownItemComponent2(import14.RenderView parentView, int parentIndex) : super(parentView, parentIndex);
  @override
  void build() {
...
import13.EmbeddedView<void> viewFactory_MaterialSelectDropdownItemComponent2<T>(import14.RenderView parentView, int parentIndex) {
  return _ViewMaterialSelectDropdownItemComponent2<T>(parentView, parentIndex);
}

class _ViewMaterialSelectDropdownItemComponent3<T> extends import13.EmbeddedView<import2.MaterialSelectDropdownItemComponent<T>> {
  import15.ViewMaterialCheckboxComponent0 _compView_0;
  import16.MaterialCheckboxComponent _MaterialCheckboxComponent_0_5;
  var _expr_0;
  var _expr_1;
  _ViewMaterialSelectDropdownItemComponent3(import14.RenderView parentView, int parentIndex) : super(parentView, parentIndex);
  @override
  void build() {
...
import13.EmbeddedView<void> viewFactory_MaterialSelectDropdownItemComponent3<T>(import14.RenderView parentView, int parentIndex) {
  return _ViewMaterialSelectDropdownItemComponent3<T>(parentView, parentIndex);
}

class _ViewMaterialSelectDropdownItemComponent4<T> extends import13.EmbeddedView<import2.MaterialSelectDropdownItemComponent<T>> {
  ViewContainer _appEl_1;
  NgIf _NgIf_1_9;
  _ViewMaterialSelectDropdownItemComponent4(import14.RenderView parentView, int parentIndex) : super(parentView, parentIndex);
  @override
  void build() {
    final doc = import8.document;
...
import13.EmbeddedView<void> viewFactory_MaterialSelectDropdownItemComponent4<T>(import14.RenderView parentView, int parentIndex) {
  return _ViewMaterialSelectDropdownItemComponent4<T>(parentView, parentIndex);
}

class _ViewMaterialSelectDropdownItemComponent5<T> extends import13.EmbeddedView<import2.MaterialSelectDropdownItemComponent<T>> {
  import18.ViewGlyphComponent0 _compView_0;
  import19.GlyphComponent _GlyphComponent_0_5;
  _ViewMaterialSelectDropdownItemComponent5(import14.RenderView parentView, int parentIndex) : super(parentView, parentIndex);
  @override
  void build() {
...
import13.EmbeddedView<void> viewFactory_MaterialSelectDropdownItemComponent5<T>(import14.RenderView parentView, int parentIndex) {
  return _ViewMaterialSelectDropdownItemComponent5<T>(parentView, parentIndex);
}

class _ViewMaterialSelectDropdownItemComponent6<T> extends import13.EmbeddedView<import2.MaterialSelectDropdownItemComponent<T>> {
  final import20.TextBinding _textBinding_1 = import20.TextBinding();
  _ViewMaterialSelectDropdownItemComponent6(import14.RenderView parentView, int parentIndex) : super(parentView, parentIndex);
  @override
  void build() {
    final doc = import8.document;
    final _el_0 = doc.createElement('span');
...
import13.EmbeddedView<void> viewFactory_MaterialSelectDropdownItemComponent6<T>(import14.RenderView parentView, int parentIndex) {
  return _ViewMaterialSelectDropdownItemComponent6<T>(parentView, parentIndex);
}

class _ViewMaterialSelectDropdownItemComponent7<T> extends import13.EmbeddedView<import2.MaterialSelectDropdownItemComponent<T>> {
  ...
  var _expr_1;
  var _expr_2;
  _ViewMaterialSelectDropdownItemComponent7(import14.RenderView parentView, int parentIndex) : super(parentView, parentIndex);
  @override
  void build() {
    final _ctx = this.ctx;
...
import13.EmbeddedView<void> viewFactory_MaterialSelectDropdownItemComponent7<T>(import14.RenderView parentView, int parentIndex) {
...
class _ViewMaterialSelectDropdownItemComponentHost0<T> extends import26.HostView<import2.MaterialSelectDropdownItemComponent<T>> {
  @override
  void build() {
    this.componentView = ViewMaterialSelectDropdownItemComponent0(this, 0);
    final _el_0 = this.componentView.rootElement;
    this.component = (import9.isDevMode
        ? import24.debugInjectorWrap(import2.MaterialSelectDropdownItemComponent, () {
            return import2.MaterialSelectDropdownItemComponent(_el_0, null, this.injectorGetOptional(import27.DropdownHandle, this.parentIndex), this.injectorGetOptional(import28.ActivationHandler, this.parentIndex), this.injectorGetOptional(import29.IdGenerator, this.parentIndex), this.componentView);
          })
        : import2.MaterialSelectDropdownItemComponent(_el_0, null, this.injectorGetOptional(import27.DropdownHandle, this.parentIndex), this.injectorGetOptional(import28.ActivationHandler, this.parentIndex), this.injectorGetOptional(import29.IdGenerator, this.parentIndex), this.componentView));
    this.initRootNode(_el_0);
  }

  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if (((identical(token, import30.SelectionItem) || identical(token, import31.HasRenderer)) && (0 == nodeIndex))) {
...
import26.HostView<import2.MaterialSelectDropdownItemComponent<T>> viewFactory_MaterialSelectDropdownItemComponentHost0<T>() {
